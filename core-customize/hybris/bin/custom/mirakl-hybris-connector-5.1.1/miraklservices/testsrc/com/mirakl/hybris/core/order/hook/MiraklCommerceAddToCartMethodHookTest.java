...
public class MiraklCommerceAddToCartMethodHookTest {
  private static final String OFFER_ID = "12000";

  @InjectMocks
  private MiraklCommerceAddToCartMethodHook hook;
  @Mock
  ...
  public void setUp() throws Exception {
    when(cartParameter.getOffer()).thenReturn(offerModel);
  ...
  public void shouldCallServiceUpdateWhenSynchronousCartUpdateIsEnabledAndInvalidateShippingFees() {
    ...
    hook.beforeAddToCart(cartParameter);
  ...
  @Test
  public void shouldNotCallServiceUpdateWhenSynchronousCartUpdateIsEnabledAndInvalidateShippingFees() {
